...
Перем СхемаКомпоновкиДанных Экспорт; // СхемаКомпоновкиДанных
Перем НаборДанных; // НаборДанныхЗапросСхемыКомпоновкиДанных или НаборДанныхОбъектСхемыКомпоновкиДанных
Перем ПолеНабораДанных; // ПолеНабораДанныхСхемыКомпоновкиДанных
Перем ПолеРесурса; // ПолеИтогаСхемыКомпоновкиДанных
Перем ВычисляемоеПоле; // ВычисляемоеПолеСхемыКомпоновкиДанных
Перем ПараметрСхемы; // ПараметрСхемыКомпоновкиДанных
Перем Раздел; // Число
Перем Разделы; // Структура
Перем НомерПериода; // Число
Перем Роль; // РольПоляСхемыКомпоновкиДанных
Перем ВнешниеНаборыДанных Экспорт; // Структура
Перем НаборыДанных Экспорт; // НаборыДанныхСхемыКомпоновкиДанных
Перем КолонкиНабораДанных; // КоллекцииКолонокТаблицы
Перем Соединение; // СвязьНаборовДанныхСхемыКомпоновкиДанных
Перем ВариантНастроек; // ВариантНастроекКомпоновкиДанных

Перем Настройки; // НастройкиКомпоновкиДанных
Перем ВыбранноеПоле; // ВыбранноеПолеКомпоновкиДанных или АвтоВыбранноеПолеКомпоновкиДанных
Перем ГруппаВыбранныхПолей; // ГруппаВыбранныхПолейКомпоновкиДанных
Перем ГруппаОтбора; // ГруппаЭлементовОтбораКомпоновкиДанных
Перем ЭлементОтбора; // ЭлементОтбораКомпоновкиДанных
Перем Группировка; // ГруппировкаКомпоновкиДанных или ГруппировкаТаблицыКомпоновкиДанных
Перем ПолеГруппировки; // ПолеГруппировкиКомпоновкиДанных или АвтоПолеГруппировкиКомпоновкиДанных
Перем Таблица; // ТаблицаКомпоновкиДанных
Перем ЭлементУсловногоОформления; // ЭлементУсловногоОформленияКомпоновкиДанных
Перем ОформляемоеПоле; // ОформляемоеПолеКомпоновкиДанных
