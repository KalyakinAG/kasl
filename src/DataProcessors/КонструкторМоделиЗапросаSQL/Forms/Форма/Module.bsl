...
Процедура ЗаполнитьПараметрыСоединенияТекущейБазы(Объект)
	...
	Объект.ПривестиУИНКСтроке = Истина;
...
Функция ВыполнитьЗапрос(ТекстЗапроса, ПараметрыСоединения, ЭтоЗапросНаИзменение)
	...
	Таблица = РаботаС_ADODB.ВыполнитьЗапрос(СоединениеADODB, ТекстЗапроса, ПараметрыСоединения.СмещениеДат2000, ПараметрыСоединения.ПривестиУИНКСтроке);
