...
Процедура ПриИзменении(Элемент)
	//  МодельСостояния
	МодельОбъекта = РаботаСМодельюОбъектаКлиентСервер.НоваяМодельОбъекта(ЭтотОбъект);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	МодельСостояния = РаботаСМодельюСостояния.НоваяМодельСостояния(ЭтотОбъект, , "КонструкторМоделиСостоянияМодель")
	;
...
Асинх Процедура КомандаВыбратьОкно(Команда)
	...
	МодельОбъекта = РаботаСМодельюОбъектаКлиентСервер.НоваяМодельОбъекта(ВыбраннаяФорма);
