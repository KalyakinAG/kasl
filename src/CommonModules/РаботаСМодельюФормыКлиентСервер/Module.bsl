...
Функция НастройкиПараметровВыбораТаблицыФормы(Форма, ТаблицаФормы) Экспорт
	МодельОбъекта = РаботаСМодельюОбъектаКлиентСервер.НоваяМодельОбъекта(Форма);
	...
	Для Каждого Элемент Из НайденныеЭлементы Цикл
		...
		Если НЕ ЗначениеЗаполнено(НастройкаПараметровВыбора) Тогда
			Продолжить;
		КонецЕсли;
		Если ОбщегоНазначенияКлиентСервер.СпискиЗначенийИдентичны(Элемент.СвязиПараметровВыбора, НастройкаПараметровВыбора.СвязиПараметровВыбора) И ОбщегоНазначенияКлиентСервер.СпискиЗначенийИдентичны(Элемент.ПараметрыВыбора, НастройкаПараметровВыбора.ПараметрыВыбора) Тогда
			Продолжить;
		КонецЕсли;
...
Функция ПриАктивизацииСтроки(Контекст, Элемент) Экспорт
	МодельОбъекта = РаботаСМодельюОбъектаКлиентСервер.НоваяМодельОбъекта(Контекст);
	ЭлементФормы = МодельОбъекта.ЭлементыФормы[Элемент.Имя];
	...
	Если РаботаСМодельюОбъектаКлиентСервер.УстановитьЗначениеПараметра(МодельОбъекта, ЭлементФормы.ПараметрТекущаяСтрока, Элемент.ТекущаяСтрока) Тогда
		Возврат РаботаСМодельюОбъектаКлиентСервер.НовыйРасчетныйПараметр(МодельОбъекта, ЭлементФормы.ПараметрТекущаяСтрока);
	КонецЕсли;
	Возврат Неопределено;
КонецФункции
...
Функция ОбновитьФорму(Контекст, РассчитанныеПараметры = Неопределено) Экспорт
	...
	//  Инициализация
	ИзмененныеПараметры = Новый Массив;// Массив из РаботаСМодельюОбъектаКлиентСервер.РасчетныйПараметр
...
Функция ПолучитьРасчетныйПараметрЭлементаФормы(Контекст, ИмяЭлемента, Знач ИдентификаторСтроки = Неопределено) Экспорт
	...
	КонецЕсли;
	Возврат РаботаСМодельюОбъектаКлиентСервер.НовыйРасчетныйПараметр(МодельОбъекта, ЭлементФормы.Параметр, ИдентификаторСтроки);
КонецФункции
