...
Функция ВJSON(Коллекция, КрасивоеФорматирование = Ложь, ПривестиСсылкуКСтроке = Ложь) Экспорт
	
	ТипЗначения = ТипЗнч(Коллекция);
	
	Если ТипЗначения = Тип("ТаблицаЗначений") Тогда
		
		Возврат ОбщийКлиентСервер.ЗначениеВJSON(ТаблицаЗначенийВСтруктуру(Коллекция, ПривестиСсылкуКСтроке), КрасивоеФорматирование);
		
	ИначеЕсли ТипЗначения = Тип("ДеревоЗначений") Тогда
		
		Возврат ОбщийКлиентСервер.ЗначениеВJSON(ДеревоЗначенийВСтруктуру(Коллекция, ПривестиСсылкуКСтроке), КрасивоеФорматирование);
...
Функция ИзJSON(КоллекцияJSON, НайтиСсылкуИзСтроки = Истина) Экспорт
	Перем ТипЗначения;
	...
	Если НЕ ЗначениеЗаполнено(ТипЗначения) ИЛИ ТипЗначения = "ТаблицаЗначений" Тогда
		Возврат СтруктураВТаблицуЗначений(Коллекция, НайтиСсылкуИзСтроки);
	ИначеЕсли ТипЗначения = "ДеревоЗначений" Тогда
		Возврат СтруктураВДеревоЗначений(Коллекция, НайтиСсылкуИзСтроки);
	Иначе
		ВызватьИсключение "Неизвестный тип коллекции " + ТипЗначения;
	КонецЕсли;
КонецФункции
